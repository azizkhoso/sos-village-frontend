...
import { updateRecord } from '../../../api/admin/records';
...
export default function UpdateRecord() {
  ...
  const [house, setHouse] = useState(location.state.house._id); // Hosue Id in string format
  const [quantityIssued, setQuantityIssued] = useState(location.state.quantityIssued);
  ...
  return (
    <div className="flex flex-col w-full h-full gap-6">
      <Typography variant="h6" align="center" className="w-full lg:w-9/12">Update Record</Typography>
