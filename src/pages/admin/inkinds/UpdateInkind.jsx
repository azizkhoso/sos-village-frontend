...
import { updateInkind } from '../../../api/admin/inkinds';

export default function UpdateInkind() {
  ...
  const { isLoading, mutate } = useMutation(
    ...
    {
      onSuccess: () => {
        toastsStore.addToast({ message: 'Inkind updated successfully', severity: 'success' });
  ...
  return (
    <div className="flex flex-col w-full h-full gap-6">
      <Typography variant="h6" align="center" className="w-full lg:w-9/12">Update Inkind</Typography>
