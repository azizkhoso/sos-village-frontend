...
import { updateHouse } from '../../../api/admin/houses';
...
export default function UpdateHouse() {
  ...
  return (
    <div className="flex flex-col w-full h-full gap-6">
      <Typography variant="h6" align="center" className="w-full lg:w-9/12">Update House</Typography>
