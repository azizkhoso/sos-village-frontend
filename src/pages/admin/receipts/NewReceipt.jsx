...
import { addReceipt } from '../../../api/admin/receipts';
...
export default function NewReceipt() {
  ...
  const { isLoading, mutate } = useMutation(
    ...
    {
      onSuccess: () => {
        toastsStore.addToast({ message: 'Receipt added successfully', severity: 'success' });
  ...
  return (
    <div className="flex flex-col w-full h-full gap-6">
      <Typography variant="h6" align="center" className="w-full lg:w-9/12">New Receipt</Typography>
